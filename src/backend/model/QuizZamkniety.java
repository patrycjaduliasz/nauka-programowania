...
public class QuizZamkniety {
    private int id;
    private int idUzytkownika;
    private int idKategorii;
    private int wynik;
    private int liczbaPytan;
    private LocalDateTime dataProby;
    ...
    public LocalDateTime getDataProby() {
        return dataProby;
    }

    public void setDataProby(LocalDateTime dataProby) {
        this.dataProby = dataProby;
    }
}